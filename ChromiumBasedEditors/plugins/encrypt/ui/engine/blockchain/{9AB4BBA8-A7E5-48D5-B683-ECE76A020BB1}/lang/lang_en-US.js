ONLYONET.Resources = {
    ...
    "box-blockchain-connect-description-line31": "Before you start:",
    "box-blockchain-connect-description-line32": "Log in to your ONLYOFFICE portal via Connect to cloud section",
    "box-blockchain-connect-description-line33": "Obtain your personal encryption data using the button below.",
    "box-blockchain-connect-description-line44": "ONLYOFFICE will generate your individual pair of the encryption keys: public and private. Your private key (used for decrypting the documents) will be stored on this machine. For the correct work of the application, do not remove this file. You may keep a copy in some other location as a backup.",
    "box-blockchain-connect-btn-create1": "Generate new credentials",
    "box-blockchain-connect-btn-cancel1": "Use the existing credentials",
