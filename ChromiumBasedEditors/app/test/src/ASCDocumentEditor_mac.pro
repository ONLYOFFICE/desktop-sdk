...
QMAKE_POST_LINK += cp -R $${DESTDIR}/Info.plist $${DESTDIR}/ASCDocumentEditor\ Helper.app/Contents;
QMAKE_POST_LINK += install_name_tool \
-change \
@executable_path/Chromium\ Embedded\ Framework \
@executable_path/../../../../Frameworks/Chromium\ Embedded\ Framework.framework/Chromium\ Embedded\ Framework \
$$quote($$DESTDIR)/ASCDocumentEditor\ Helper.app/Contents/MacOS/ASCDocumentEditor\ Helper
