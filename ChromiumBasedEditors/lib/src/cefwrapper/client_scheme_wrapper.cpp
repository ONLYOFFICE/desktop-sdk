...
public:
	...
	OVERRIDE
	{
		...
		if (posFind != std::string::npos)
		{
			std::string sPageCrash;
			CApplicationManagerAdditionalBase* pAdditional = m_pManager->m_pInternal->m_pAdditional;
			if (pAdditional)
				sPageCrash = pAdditional->GetCrashPage();
			...
			if (sPageCrash.empty())
			{
				...
				sPageCrash = sPageCrash1 + sPageCrash2;
			}
